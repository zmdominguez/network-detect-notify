...
public class SharedPrefsManager {
	...
	public static final String QDI_PREFS = "com.blogspot.droidista.prefs";
	public static final String KEY_HAS_NETWORK = "app.has.network";
	
	private static final String LOG_TAG = "ZSharedPrefsManager";
